...
def gen_option_data(optionCode: str, k: str='30', market: str='sh'):
    ...
    # 1. 输入框
    search_img = f'./Fintech/tools/pics/search_button.png'
    ...
    # 2. 搜索按钮
    find_img = f'./Fintech/tools/pics/find.png'
    ...
    # 3. 市场选择
    if market == 'sh':
        market_img = f'./Fintech/tools/pics/sh.png'
        market_name = "上海市场(sh)"
    else:
        market_img = f'./Fintech/tools/pics/sz.png'
        market_name = "深圳市场(sz)"
    ...
    # 4. 时间周期
    time_interval = f'./Fintech/tools/pics/{k}.png'
    ...
    # 5. 导出数据菜单
    gen_data = f'./Fintech/tools/pics/gendata2.png'
    ...
    # 6. 确认导出
    gen = f'./Fintech/tools/pics/gen.png'
    ...
    no_data = f'./Fintech/tools/pics/no_data.png'
    try:
        # 这里单独 try，因为找不到是正常的
    ...
    # 8. 保存/取消按钮
    # save_and_cancel = f'./Fintech/tools/pics/save_K.png'
    # save_and_cancel = f'./Fintech/tools/pics/save_and_cancel.png'
